...
extension Defaults.Keys {
    ...
    static let audioReactiveVisualizer = Key<Bool>("audioReactiveVisualizer", default: false)
    ...
    static let scrollGesturesEnabled = Key<Bool>("scrollGesturesEnabled", default: true)
